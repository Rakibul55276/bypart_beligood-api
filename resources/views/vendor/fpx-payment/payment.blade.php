                ...
                <div class="col-md-4 order-md-2 mb-4">
                    <div class="border p-3 mb-3 rounded">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                {!! Form::select('bank_id', [null => 'Select Bank'] + $banks->toArray(), $test ?
                                'TEST0021' : $request->bank_id, ['class' => 'form-control', 'required' => '']) !!}
                            </div>
                        </div>
                        ...
                        <button class="btn btn-primary btn-lg btn-block" id="model" type="submit" >Proceed</button>
                    </div>
                </div>
                    ...
                    <div class="border p-3 mb-3 rounded">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="customer_name" name="customer_name"
                                    ...
                                    value="{{ $test ? 'Test Buyer Name' : $request->customer_name }}" required readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="amount" name="amount" placeholder="1.00"
                                value="{{ $test ? '1.0' : $request->amount }}" required readonly>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="remark" name="remark"
                                placeholder="Enter Product Description">{{ $test ? 'Test Data' : $request->remark }}</textarea>
                            <div class="invalid-feedback">
